...
def test_navigate_to_locations_from_gm(page, app_url, seeded_game_with_locations):
...
def test_navigate_to_events_from_gm(page, app_url, seeded_game_with_locations):
    seed = seeded_game_with_locations
    gm = GameMasterPage(page, seed["gm_token"], app_url)
    gm.goto()
